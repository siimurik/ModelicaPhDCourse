...
package W2_DataHandling
    package Configurations
        model SimpleCar "Tests acceleration at full throttle"
            extends Templates.StandardCar(redeclare replaceable .TrainingPack.Day4.W2_DataHandling.SubSystems.BasicEngine engine,redeclare replaceable .TrainingPack.Day4.W2_DataHandling.SubSystems.FixedTransmission transmission,redeclare replaceable .TrainingPack.Day4.W2_DataHandling.SubSystems.RigidShaft driveline,redeclare replaceable .TrainingPack.Day4.W2_DataHandling.SubSystems.IdealChassis chassis);
