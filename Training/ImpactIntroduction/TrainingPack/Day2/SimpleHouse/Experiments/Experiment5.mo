...
model Experiment5
    ...
    .Modelica.Blocks.Sources.Sine OutAirT(offset = 263.15,phase = -1.57079632679489499834,f = 1 / 86400,amplitude = 5) annotation(Placement(transformation(extent = {{-88.0,68.0},{-68.0,88.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Sources.Sine sine(amplitude = 0,f = 1 / 86400,phase = -1.57079632679489499834) annotation(Placement(transformation(extent = {{-90.67,22.0},{-70.67,42.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Buildings.Fluid.Sources.Boundary_pT watSink(nPorts = 1,redeclare package Medium = .Buildings.Media.Water) annotation(Placement(transformation(extent = {{101.0,-98.0},{81.0,-78.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .TrainingPack.Day2.SimpleHouse.Building.HouseWallWinRad houseWallWinRad annotation(Placement(transformation(extent = {{27.57,10.56},{87.93,70.92}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
    ...
    connect(prescribedTemperature.port,houseWallWinRad.outside) annotation(Line(points = {{-14,48},{6.85,48},{6.85,46.57},{27.44,46.57}},color = {191,0,0}));
    connect(radiator.port_house,houseWallWinRad.rad) annotation(Line(points = {{13,-78},{13,-50},{36,-50},{36,-19.09},{79.48,-19.09},{79.48,10.56}},color = {191,0,0}));
    connect(senTem.port_b,watSink.ports[1]) annotation(Line(points = {{63,-88},{81,-88}},color = {0,127,255}));
    ...
    connect(solRad.y,houseWallWinRad.u) annotation(Line(points = {{-25.67,12},{-1.01,12},{-1.01,28.47},{21.4,28.47}},color = {0,0,127}));
    connect(hys.u,temperatureSensor.T) annotation(Line(points = {{-76,-50},{-88,-50},{-88,-28},{-34,-28},{-34,-18},{-9,-18}},color = {0,0,127}));
    connect(temperatureSensor.port,houseWallWinRad.rad) annotation(Line(points = {{12,-18},{79.48,-18},{79.48,10.56}},color = {191,0,0}));
