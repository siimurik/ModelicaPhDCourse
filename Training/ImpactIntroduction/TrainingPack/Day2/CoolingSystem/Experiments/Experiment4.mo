...
model Experiment4
    ...
    .Modelica.Blocks.Continuous.Integrator coolEnergy(k = -1 / 3600000) annotation(Placement(transformation(extent = {{61.24,-82.69},{81.24,-62.69}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .TrainingPack.Day2.CoolingSystem.Components.Chiller chiller annotation(Placement(transformation(extent = {{15.98,-77.98},{35.98,-57.98}},origin = {0,0},rotation = 0)));
    .Buildings.BoundaryConditions.WeatherData.Bus weaBus annotation(Placement(transformation(extent = {{-50.62,53.76},{-18.76,85.62}},origin = {0.0,0.0},rotation = 0.0)));
equation
    ...
    connect(zonHVAC.TAir,conPID.u_m) annotation(Line(points = {{83.86,10.16},{89.86,10.16},{89.86,-92.82},{-91.81,-92.82},{-91.81,-59.83},{-53.11,-59.83},{-53.11,-51.27}},color = {0,0,127}));
    ...
    connect(pump.port_b,chiller.returnWat) annotation(Line(points = {{-19.33,-63.58},{-19.33,-69.58},{10,-69.58},{10,-67.92},{16,-67.92}},color = {0,127,255}));
    connect(weaBus.TDryBul,chiller.Tsource) annotation(Line(points = {{-34.69,69.69},{-10.34,69.69},{-10.34,-63.94},{14,-63.94}},color = {255,204,51}));
    connect(supWatTem.y,chiller.Twater) annotation(Line(points = {{-61.54,-77.43},{-23.77,-77.43},{-23.77,-59.98},{14,-59.98}},color = {0,0,127}));
    connect(chiller.supplyWat,coolCoil.port_a2) annotation(Line(points = {{35.96,-67.98},{41.96,-67.98},{41.96,-10.05},{7.61,-10.05}},color = {0,127,255}));
    connect(bou.ports[1],chiller.supplyWat) annotation(Line(points = {{61.64,-40.21},{48.8,-40.21},{48.8,-67.98},{35.96,-67.98}},color = {0,127,255}));
    connect(chiller.y,coolEnergy.u) annotation(Line(points = {{37.68,-61.97},{48.46,-61.97},{48.46,-72.69},{59.24,-72.69}},color = {0,0,127}));
