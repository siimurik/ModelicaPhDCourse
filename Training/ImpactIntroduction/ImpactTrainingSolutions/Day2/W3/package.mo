    ...
    package WorkflowMultiStageSim
        package DataAccess
            ...
            model DataAccessBlock
                constant String filename = Modelica.Utilities.Files.loadResource("modelica://ImpactTrainingSolutions/Resources/example.xml");
        ...
        model Step1_Setup
            ...
            .Modelica.Mechanics.Translational.Components.Mass mass(m = dataAccessBlock.m) annotation(Placement(transformation(extent = {{8.909651360544231,20.252869897959187},{28.90965136054423,40.25286989795919}},origin = {0,0},rotation = 0)));
            ...
            .Modelica.Mechanics.Translational.Sensors.PositionSensor positionSensor annotation(Placement(transformation(extent = {{13,-40},{33,-20}},origin = {0,0},rotation = 0)));
            .ImpactTrainingSolutions.Day2.W3.WorkflowMultiStageSim.DataAccess.DataAccessBlock dataAccessBlock(t_write = 15,t_store = 18) annotation(Placement(transformation(extent = {{62,-40},{82,-20}},origin = {0,0},rotation = 0)));
        equation
            ...
            connect(mass.flange_a,positionSensor.flange) annotation(Line(points = {{8.909651360544238,30.252869897959187},{2.9096513605442382,30.252869897959187},{2.9096513605442382,-30},{13,-30}},color = {0,127,0}));
            ...
            connect(positionSensor.s,dataAccessBlock.value) annotation(Line(points = {{34,-30},{60,-30}},color = {0,0,127}));
            annotation(Icon(coordinateSystem(preserveAspectRatio = false,extent = {{-100.0,-100.0},{100.0,100.0}}),graphics = {Rectangle(lineColor={0,0,0},fillColor={230,230,230},fillPattern=FillPattern.Solid,extent={{-100.0,-100.0},{100.0,100.0}}),Text(lineColor={0,0,255},extent={{-150,150},{150,110}},textString="%name")}),experiment(StopTime = 20));
        end Step1_Setup;
        model Step2_DynamicAnalysis
            ...
            .Modelica.Mechanics.Translational.Components.SpringDamper springDamper(c = dataAccessBlock.c,d = dataAccessBlock.d) annotation(Placement(transformation(extent = {{35.57631802721089,20.252869897959187},{55.57631802721089,40.25286989795919}},origin = {0,0},rotation = 0)));
            .ImpactTrainingSolutions.Day2.W3.WorkflowMultiStageSim.DataAccess.DataAccessBlockRead dataAccessBlock annotation(Placement(transformation(extent = {{-20,-40},{0,-20}},origin = {0,0},rotation = 0)));
        equation
            connect(mass.flange_b,springDamper.flange_a) annotation(Line(points = {{28.90965136054424,30.252869897959187},{35.576318027210895,30.252869897959187}},color = {0,127,0}));
            connect(springDamper.flange_b,fixed.flange) annotation(Line(points = {{55.57631802721089,30.252869897959187},{64.58567176870748,30.252869897959187},{64.58567176870748,10.582376700680271}},color = {0,127,0}));
            annotation(Icon(coordinateSystem(preserveAspectRatio = false,extent = {{-100.0,-100.0},{100.0,100.0}}),graphics = {Rectangle(lineColor={0,0,0},fillColor={230,230,230},fillPattern=FillPattern.Solid,extent={{-100.0,-100.0},{100.0,100.0}}),Text(lineColor={0,0,255},extent={{-150,150},{150,110}},textString="%name")}),experiment(StopTime = 20));
        ...
        model SeriesDriveCycle "Drive cycle experiment for a series hybrid powertrain"
          extends Electrification.Examples.SeriesDriveCycle(
            ...
            battery(
              ...
              redeclare replaceable Electrification.Batteries.Records.Deprecated.Summary summary));
          annotation (experiment(StopTime=100000, Interval=1000));
        end SeriesDriveCycle;
    end MultiSim;
end W3;
